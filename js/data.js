    ...
    games: [
        {
            ...
            overview: "An immersive action RPG with stunning visuals and engaging gameplay mechanics",
            description: "Embark on an epic journey through mystical lands filled with ancient secrets and powerful enemies. This action-packed RPG features a dynamic combat system, character progression, and an expansive open world to explore. Battle fearsome creatures, complete challenging quests, and uncover the truth behind the legendary artifacts that shaped this world.",
        ...
        },
        {
            ...
            overview: "Brain-teasing puzzle game with innovative mechanics",
            description: "Challenge your mind with hundreds of unique puzzles designed to test your logic and problem-solving skills. Features innovative mechanics, beautiful minimalist design, and progressively challenging levels.",
            ...
            technologies: ["Unity", "C#", "Illustrator", "Unity IAP"],
            repositoryUrl: "https://github.com/ArshVermaGit/puzzle-master-pro",
        ...
        },
        {
            id: 4,
            name: "Space Defender",
            overview: "Classic arcade-style space shooter with modern twist",
            description: "Defend Earth from alien invaders in this action-packed space shooter. Upgrade your ship, unlock powerful weapons, and face increasingly challenging waves of enemies.",
        ...
        },
        {
            ...
            overview: "Strategic city-building simulation game",
            description: "Build and manage your dream city from the ground up. Balance resources, keep citizens happy, and create a thriving metropolis in this engaging simulation game.",
            ...
            features: [
                ...
                "Citizen happiness and needs",
                "Disasters and emergencies",
                "Multiple building types and upgrades",
                "Seasonal events and challenges"
            ],
            technologies: ["Unity", "C#", "Blender", "Photoshop", "Firebase"],
            repositoryUrl: "https://github.com/ArshVermaGit/city-builder-tycoon",
            playUrl: "games/city-builder",
            screenshots: [
                "assets/games/game5-1.jpg",
                "assets/games/game5-2.jpg",
                "assets/games/game5-3.jpg"
            ]
        },
        {
            id: 6,
            name: "Rhythm Warrior",
            overview: "Music-based action game with rhythm gameplay",
            description: "Slash through enemies to the beat of epic soundtracks. Combine rhythm game mechanics with action gameplay for a unique and engaging experience.",
            ...
            technologies: ["Unity", "C#", "FMOD", "Wwise", "Blender"],
            repositoryUrl: "https://github.com/ArshVermaGit/rhythm-warrior",
            playUrl: "games/rhythm-warrior",
            screenshots: [
                "assets/games/game6-1.jpg",
                "assets/games/game6-2.jpg",
                "assets/games/game6-3.jpg"
            ]
        }
    ],
    ...
    websites: [
        {
            ...
            screenshots: [
                ...
                "assets/websites/website1-4.jpg"
            ]
        },
        {
            id: 2,
            name: "E-Commerce Pro",
            overview: "Full-featured online shopping platform with advanced e-commerce capabilities",
            description: "A complete e-commerce solution built with modern web technologies. Features include product catalog, shopping cart, secure payment processing, user accounts, order tracking, and admin dashboard. Optimized for performance and conversion.",
        ...
        },
        {
            ...
            description: "A modern health platform for tracking wellness metrics, connecting with healthcare providers, and managing appointments. Features include health tracking, progress analytics, appointment scheduling, and a supportive community.",
            ...
            pageLoadTime: "1.5s",
            mobileResponsive: true,
            technologies: ["Vue.js", "Express", "PostgreSQL", "Firebase", "Chart.js"],
            features: [
        ...
        },
        {
            ...
            overview: "Modern portfolio website template for creatives and developers",
            description: "A beautifully designed portfolio website template featuring smooth animations, dark/light mode, responsive design, and easy customization. Perfect for showcasing projects and skills.",
            ...
            repositoryUrl: "https://github.com/ArshVermaGit/portfolio-showcase",
            liveUrl: "https://portfolioshowcase.example.com",
            screenshots: [
        ...
        },
        {
            ...
            overview: "Complete food ordering and delivery service platform",
            description: "A comprehensive food delivery platform connecting restaurants with customers. Features real-time order tracking, multiple payment options, restaurant management, and delivery optimization.",
            image: "assets/websites/website5.jpg",
            ...
            repositoryUrl: "https://github.com/ArshVermaGit/food-delivery-platform",
            liveUrl: "https://fooddelivery.example.com",
            screenshots: [
                "assets/websites/website5-1.jpg",
                "assets/websites/website5-2.jpg",
                "assets/websites/website5-3.jpg"
            ]
        },
        {
            id: 6,
            name: "Learning Management System",
            overview: "Modern educational platform for online courses and learning",
            description: "A feature-rich LMS for creating, managing, and delivering online courses. Includes video lessons, quizzes, assignments, progress tracking, and certificates.",
            image: "assets/websites/website6.jpg",
            category: "Education",
            rating: 4.9,
            status: "Live",
            ...
            pageLoadTime: "1.3s",
            mobileResponsive: true,
            technologies: ["Next.js", "Node.js", "PostgreSQL", "AWS S3", "Stripe"],
            features: [
            ...
            repositoryUrl: "https://github.com/ArshVermaGit/learning-management-system",
            liveUrl: "https://lms.example.com",
            screenshots: [
                "assets/websites/website6-1.jpg",
                "assets/websites/website6-2.jpg",
                "assets/websites/website6-3.jpg"
            ]
        }
    ],
