...
const PORTFOLIO_DATA = {
    ...
    apps: [
        {
            id: 1,
            name: "Zomato Customer App",
            overview: "The Ultimate Food & Lifestyle Experience - A comprehensive platform for food delivery, dining, nightlife, and events",
            description: "Zomato Customer App is a pixel-perfect, cross-platform replication of the Zomato consumer ecosystem that goes beyond just food delivery. It integrates Dining, Nightlife, Events, and AI-powered recommendations into a single, cohesive experience. This production-grade application demonstrates modern frontend architecture with smart discovery, personalized recommendations, table booking, event ticketing, and an AI concierge powered by Google Gemini.",
            image: "static/images/apps/Zomato-Customer-App/Zomato.jpg",
            ...
            technologies: ["React 19", "TypeScript", "Vite 6", "Capacitor", "Google Gemini API", "Lucide React"],
            features: [
                "Smart restaurant discovery with personalized recommendations",
                "Full e-commerce cart and checkout with coupon application",
                "Live order tracking with animated status updates",
                "Table booking with time-slot selection",
                "Event ticketing for music festivals, comedy shows, and parties",
                "AI Concierge powered by Google Gemini",
                "Curated collections and trending lists",
                "Zomato Gold membership program with exclusive perks",
                "Nightlife and venue exploration",
                "Visual menus with rich media galleries",
                "Dark mode with glassmorphism design",
                "Cross-platform native capabilities"
            ],
            repositoryUrl: "https://github.com/ArshVermaGit/zomato-customer-app",
            appStoreUrl: "https://apps.apple.com/app/Zomato-Customer-App",
            playStoreUrl: "https://play.google.com/store/apps/details?id=com.Zomato-Customer-App",
            screenshots: [
                "static/images/apps/Zomato-Customer-App/2.jpg",
                "static/images/apps/Zomato-Customer-App/3.jpg",
                "static/images/apps/Zomato-Customer-App/4.jpg",
                "static/images/apps/Zomato-Customer-App/5.jpg"
            ]
        }
    ],
