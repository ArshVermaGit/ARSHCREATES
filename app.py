...
GAMES = [
    {
        'id': 1,
        'name': 'Sky Surfers',
        'overview': 'An intense dodging game where you fly a plane through a danger-filled valley.',
        'description': 'Skillfully pilot your plane through a hazard-filled canyon to set a new high-score.',
...
WEBSITES = [
    {
        'id': 1,
        'name': 'ReelSpot',
        'description': 'Multi-platform media saving made simple. Paste your link, download your video.',
...
PHOTOS = [
    {
        ...
        'description': 'Showcases the symbol of love.',
        'category': 'Love',
    ...
    {
        'id': 3,
        'title': 'The Academic Block',
        'description': 'A beautiful click of the academic block.',
        'category': 'VIT Bhopal',
    ...
    },
    {
        'id': 4,
        'title': 'The Block-1',
        'description': 'A beautiful click of Block-1.',
        'category': 'VIT Bhopal',
...
def contact():
    """Handle contact form submission with validation and feedback storage"""
    try:
...
def admin_feedback():
    """Render admin feedback management page"""
    try:
        with open(FEEDBACK_FILE, 'r') as f:
            feedbacks = json.load(f)
...
def export_feedback_csv():
    """Export feedback data as CSV with filtering"""
    try:
...
def api_feedback():
    """API endpoint to retrieve feedback data as JSON"""
    try:
        with open(FEEDBACK_FILE, 'r') as f:
            feedbacks = json.load(f)
